...
import { faArrowLeft, faEye, faPen, faPills, faPlus, faSave, faTrash, faUndoAlt } from '@fortawesome/free-solid-svg-icons';
...
@Component({
  ...
  templateUrl: './retour-depot.component.html',
  providers: [provideNativeDateAdapter(), { provide: MAT_DATE_LOCALE, useValue: 'fr-FR' }], 
  changeDetection: ChangeDetectionStrategy.OnPush,
  styleUrl: './retour-depot.component.scss'
})
export class RetourDepotComponent {
